...
// CreateNewsletter provides a mock function with given fields: ctx, n
func (_m *MockNewsletterStore) CreateNewsletter(ctx context.Context, n model.Newsletter) error {
	ret := _m.Called(ctx, n)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.Newsletter) error); ok {
		r0 = rf(ctx, n)
	} else {
		r0 = ret.Error(0)
	}
...
// MockNewsletterStore_CreateNewsletter_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateNewsletter'
type MockNewsletterStore_CreateNewsletter_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - n model.Newsletter
func (_e *MockNewsletterStore_Expecter) CreateNewsletter(ctx interface{}, n interface{}) *MockNewsletterStore_CreateNewsletter_Call {
	return &MockNewsletterStore_CreateNewsletter_Call{Call: _e.mock.On("CreateNewsletter", ctx, n)}
}

func (_c *MockNewsletterStore_CreateNewsletter_Call) Run(run func(ctx context.Context, n model.Newsletter)) *MockNewsletterStore_CreateNewsletter_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.Newsletter))
	})
	return _c
}

func (_c *MockNewsletterStore_CreateNewsletter_Call) Return(_a0 error) *MockNewsletterStore_CreateNewsletter_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockNewsletterStore_CreateNewsletter_Call) RunAndReturn(run func(context.Context, model.Newsletter) error) *MockNewsletterStore_CreateNewsletter_Call {
	_c.Call.Return(run)
	return _c
}
